...
const Footer = () => {
  return (
    <>
      <div className="text-white my-10 flex items-center justify-evenly">
        <div className="flex flex-col gap-6">
          <h1 className="text-[3.5rem] font-extrabold max-w-[800px]">
        ...
        <Link
          href="/contact"
          className="text-white bg-red-600 px-10 py-3 rounded "
        >
          Contact
        </Link>
      </div>
      <div className="flex justify-between px-32 py-2 bg-[#101010] items-center">
        <Image src="/assets/logo01.png" width={80} height={50} alt="" />
        <div className="flex gap-20 text-[2rem] text-white">
